...
public class BasicNotificationService implements NotificationService {
    ...
    public List<NotificationDto> findAllByReceiverId(UUID receiverId) {
        ...
        List<NotificationDto> notifications = notificationRepository.findByReceiverIdOrderByCreatedAtDesc(
                receiverId)
            .stream()
    ...
    public void create(UUID receiverId, String title, String content,
        ...
        log.debug("새 알림 생성 시작: receiverId={}, channelId={}", receiverId, targetId);
